<%-- 
    Document   : addnew
    Created on : Nov 1, 2023, 12:47:17 PM
    Author     : thinh
--%>
...
<%-- 
Document   : addnew
Created on : Oct 24, 2023, 9:52:56 PM
Author     : thinh
--%>
 ...
 <input type="text" class="form-control" id="keycap_durability" name="durability_keycap">
        ...
        <input type="text" class="form-control" id="switch_type" name="type_switch">
            ...
            <div class="col-md-8 row my-2 d-flex justify-content-between">
                    ...
                    <div class="col-md-10">            
        <input type="number" class="form-control" id="switch_complexity" name="complexity_switch">
            <div class="form-message"></div>
                </div>
            </div>
            <div class="col-md-8 row my-2 d-flex justify-content-between">
                    ...
                    <div class="col-md-10">
                    <input type="number" class="form-control" id="switch_durability" name="durability_switch">
            <div class="form-message"></div>
                </div>
            </div>
            <div class="col-md-8 row my-2 d-flex justify-content-between">
                    ...
                    <div class="col-md-10">
                    <input type="number" class="form-control" id="switch_travel" name="travel_switch">
            <div class="form-message"></div>
            </div>
                </div>
               `;
                    ...
                    const validateInputs = () => {
                        ...
                        if (switch_complexityValue === '') {
                            ...
                            hasError = true;
                        } else if (!isValidNumber(switch_complexityValue)) {
                            switch_complexity.classList.add('invalid');
                            switch_complexity.classList.remove('valid');
                            setError(switch_complexity, 'Provide switch complexity valid number');
                            hasError = true;
                        } else {
                        ...
                        if (switch_durabilityValue === '') {
                            ...
                            hasError = true;
                        } else if (!isValidNumber(switch_durabilityValue)) {
                            switch_durability.classList.add('invalid');
                            switch_durability.classList.remove('valid');
                            setError(switch_durability, 'Provide switch durability valid number');
                            hasError = true;
                        } else {
                        ...
                        if (switch_travelValue === '') {
                            ...
                            switch_travel.classList.add('invalid');
                            switch_travel.classList.remove('valid');
                            setError(switch_travel, 'Provide switch travel valid number');
                            hasError = true;
                        } else {
