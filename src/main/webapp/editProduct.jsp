    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="main">
                ...
                <div class="container-fluid bg-light" style="border-radius: 10px">
                    <div class="container p-5">
                        ...
                        <form  method="post" id="form" action="AdminController" enctype="multipart/form-data" class="row my-4 g-3 needs-validation d-flex justify-content-center" novalidate>
                            ...
                            <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="Pro_price" name="txtPrice" value="<%= pro.getPro_price()%>">
                                    <div class="form-message text-start"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">
                                    <input  type="text" class="form-control" id="Pro_des" name="txtDescription" value="<%= pro.getPro_discription()%>" >
                                    <div class="form-message text-start"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="Pro_dis" name="txtDiscount" value="<%= pro.getPro_discount()%>" >
                                    <div class="form-message text-start"></div>
                                </div>
                            </div>
                            <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">
                                    <select class="form-select form-control" aria-label="Default select example" name="txtCateName" id="category" disabled="" >
                                        ...
                                        <%
                                            ...
                                            int i = pro.getCategory_id();
                                            while (rs.next()) {
                                        %>      
                                        <option value="<%= rs.getInt("product_id")%>" <%= (i == rs.getInt("product_id")) ? "selected" : ""%> > <%= rs.getString("product_name")%></option>
                                        <%
                            ...
                            <div class="col-12 my-2 d-flex justify-content-center gap-2">
                                <input type="submit" value="Edit" name="btnUpdate" class="btn btn-primary"/>
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="keyboard_led" name="led_keyboard" value="<%= keyboard.getLed()%>">
                <div class="form-message text-start"></div>
              </div>
            </div>
            <div class="col-md-8 row my-2 d-flex justify-content-between">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="keyboard_mode" name="mode_keyboard" value="<%= keyboard.getMode()%>">
            ...
            <div class="col-md-8 row my-2 d-flex justify-content-between">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="keyboard_switch" name="switchType_keyboard" value="<%= keyboard.getSwitch()%>">
                <div class="form-message"></div>
              </div>
            </div>
            <div class="col-md-8 row my-2 d-flex justify-content-between">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="keyboard_keycap" name="keycapType_keyboard" value="<%= keyboard.getKeycap()%>">
                <div class="form-message"></div>
              </div>
            </div>
                        <% } %>    `;
                        ...
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="kit_circuit" name="circuit_kit" value="<%= kit.getMach()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
            ...
            <input type="text" class="form-control" id="kit_plate" name="plate_kit" value="<%= kit.getPlate()%>">
                        <div class="form-message"></div>
                                ...
                                <div class="col-md-10">
                    <input type="number" class="form-control" id="kit_mode" name="mode_kit" value="<%= kit.getMode()%>" >
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                        ...
                        <div class="col-md-10">
                    <input type="text" class="form-control" id="kit_case" name="case_kit" value="<%= kit.getCase()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <%}%>
                        ...
                        %>
                                ...
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="keycap_material" name="material_key_cap" value="<%= keycap.getChatLieu()%>" >
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="keycap_layout" name="layout_keycap" value="<%= keycap.getLayOut()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                <div class="col-auto">
                                <label for="exampleFormControlInput1" class="form-label">Thinkness:</label>
                    </div>
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="keycap_thickness" name="thickness_keycap" value="<%= keycap.getDoDay()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                <div class="col-auto">
                                <label for="exampleFormControlInput1" class="form-label">Durability:</label>
            </div>
                                <div class="col-md-10">                   
             <input type="text" class="form-control" id="keycap_durability" name="durability_keycap" value="<%= keycap.getDoBen()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <%}%>
                        ...
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="switch_pin" name="pin_switch" value="<%= switchs.getPin()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="switch_type" name="type_switch" value="<%= switchs.getType()%>" >
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">            
                    <input type="text" class="form-control" id="switch_complexity" name="complexity_switch" value="<%= switchs.getLoxo()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" id="switch_durability" name="durability_switch" value="<%= switchs.getDoBen()%>">
                        <div class="form-message"></div>
                            </div>
                        </div>
                        <div class="col-md-8 row my-2 d-flex justify-content-between">
                                ...
                                <div class="col-md-10">
                                <input type="text" class="form-control" id="switch_travel" name="travel_switch" value="<%= switchs.getHanhTrinh()%>">
                        <div class="form-message"></div>
                        </div>
                            </div>
                        <%}%>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            const validateInputs = () => {
                                ...
                                if (pro_disValue === '') {
                                    ...
                                    hasError = true;
                                } else if (!isValidNumber(pro_disValue)) {
                                    pro_dis.classList.add('invalid');
                                    pro_dis.classList.remove('valid');
